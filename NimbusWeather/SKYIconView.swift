...
//     super.drawRect(rect)
    ...
    func play() {
        ...
        self._timer = Timer(timeInterval: 1/30, target: self, selector: #selector(update(_:)), userInfo: nil, repeats: true)
    ...
    fileprivate func drawClearDayInContext(_ ctx: CGContext, time: Double, color: CGColor) {
        ...
        sun(ctx, t: time, cx: w * 0.5, cy: h * 0.5, cw: s, s: s * STROKE, color: UIColor(red: 255/255.0, green: 235/255.0, blue: 0/255.0, alpha: 1.0).cgColor)
    }
    
    fileprivate func drawClearNightInContext(_ ctx: CGContext, time: Double, color: CGColor) {
        
        moon(ctx, t: time, cx: w * 0.5, cy: h * 0.5, cw: s, s: s * STROKE, color: UIColor(red: 252/255.0, green: 253/255.0, blue: 207/255.0, alpha: 1.0).cgColor)
    }
    
    fileprivate func drawPartlyCloudyDayInContext(_ ctx: CGContext, time: Double, color: CGColor) {
        
        ctx.beginTransparencyLayer(auxiliaryInfo: nil)
        // use 252, 215, 97 for yellow color for sun
        sun(ctx, t: time, cx: w * 0.625, cy: h * 0.375, cw: s * 0.75, s: s * STROKE, color: UIColor(red: 255/255.0, green: 235/255.0, blue: 0/255.0, alpha: 1.0).cgColor)
    ...
    fileprivate func drawPartlyCloudyNightInCotnext(_ ctx: CGContext, time: Double, color: CGColor) {
        ...
        ctx.beginTransparencyLayer(auxiliaryInfo: nil)
        moon(ctx, t: time, cx: w * 0.625, cy: h * 0.375, cw: s * 0.75, s: s * STROKE, color: UIColor(red: 252/255.0, green: 253/255.0, blue: 207/255.0, alpha: 1.0).cgColor)
        cloud(ctx, t: time, cx: w * 0.375, cy: h * 0.625, cw: s * 0.75, s: s * STROKE, color: color)
        ctx.endTransparencyLayer()
    }
    ...
    fileprivate func drawRainInContext(_ ctx: CGContext, time: Double, color: CGColor) {
        ...
        ctx.beginTransparencyLayer(auxiliaryInfo: nil)
        rain(ctx, t: time, cx: w * 0.5, cy: h * 0.37, cw: s * 0.9, s: s * STROKE, color: UIColor(red: 128/255.0, green: 222/255.0, blue: 234/255.0, alpha: 1.0).cgColor)
        cloud(ctx, t: time, cx: w * 0.5, cy: h * 0.37, cw: s * 0.9, s: s * STROKE, color: UIColor(red: 198/255.0, green: 198/255.0, blue: 198/255.0, alpha: 1.0).cgColor)
        ctx.endTransparencyLayer()
    }
    ...
    fileprivate func drawWindInContext(_ ctx: CGContext, time: Double, color: CGColor) {
        ...
        swoosh(ctx, t: time, cx: w * 0.5, cy: h * 0.5, cw: s, s: s * STROKE, index: 0, total: 2, color: UIColor.lightText.cgColor)
        swoosh(ctx, t: time, cx: w * 0.5, cy: h * 0.5, cw: s, s: s * STROKE, index: 1, total: 2, color: UIColor.lightText.cgColor)
    }
    ...
    fileprivate func drawFogInContext(_ ctx: CGContext, time: Double, color: CGColor) {
        ...
        setUpStroke(ctx, lineCapType: .round, joinCapType: .round, lineWidth: k, color: UIColor.lightText.cgColor, fillColor: nil)
    ...
    fileprivate func sleet(_ ctx: CGContext, t: Double, cx: CGFloat, cy: CGFloat, cw:CGFloat, s: CGFloat, color: CGColor) {
        ...
        setUpStroke(ctx, lineCapType: .round, joinCapType: .round, lineWidth: s * 0.2, color: color, fillColor: nil)
    ...
    fileprivate func leaf(_ ctx: CGContext, t: Double, x: CGFloat, y: CGFloat, cw:CGFloat, s: CGFloat, color: CGColor) {
        ...
        setUpStroke(ctx, lineCapType: .round, joinCapType: .round, lineWidth: s, color: UIColor(red: 102/255.0, green: 204/255.0, blue: 0/255.0, alpha: 1.0).cgColor, fillColor: color)
        ctx.beginPath()
